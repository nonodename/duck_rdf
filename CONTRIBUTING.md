# Contributing
_Adapted from [duckdb_curl_filesystem](https://github.com/dentiny/duckdb-curl-filesystem/blob/main/CONTRIBUTING.md?plain=1) with thanks_
## Did you find a bug?

* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/nonodename/duck_rdf/issues).
* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/nonodename/duck_rdf/issues/new/choose). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
...
* You cannot commit/push directly to the main branch. Instead, create a fork and file a pull request.
...
* These rules are partially enforced by `clang-tidy` and the github actions.
